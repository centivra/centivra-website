...
const Navbar: React.FC = () => {
  ...
  const navLinks = [
    ...
    { name: "Who We Are", path: "/who-we-are" },
    {
      ...
      path: "/services",
      dropdown: [
        { name: "Engineering & Development", path: "/services/engineering-and-development" },
        { name: "LLM & AI Solutions", path: "/services/llm-and-ai-solutions" },
        { name: "Design & Experience", path: "/services/design-and-experience" },
      ],
    },
